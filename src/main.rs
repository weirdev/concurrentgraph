...
fn main() -> io::Result<()> {
    ...
    */
    ...
    println!("1/10 sp");
    let sparsity = 0.1;
    bfs_sim_1(10_000, sparsity, MatMulFunction::SingleThreaded, &flu);
    bfs_sim_1(10_000, sparsity, MatMulFunction::GPU, &flu);

    println!("1/100 sp");
    let sparsity = 0.01;
    bfs_sim_1(100_000, sparsity, MatMulFunction::SingleThreaded, &flu);
    bfs_sim_1(100_000, sparsity, MatMulFunction::GPU, &flu);

    println!("1/1000 sp");
    let sparsity = 0.001;
    bfs_sim_1(1_000_000, sparsity, MatMulFunction::SingleThreaded, &flu);
    bfs_sim_1(1_000_000, sparsity, MatMulFunction::GPU, &flu);
